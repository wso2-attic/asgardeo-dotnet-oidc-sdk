...
1. Download the [PickupManagerOIDC-v1.0.3.msi](https://github.com/asgardio/asgardio-dotnet-oidc-sdk/releases/download/v1.0.3/PickupManagerOIDC-v1.0.3.msi).
2. Double click the `PickupManagerOIDC-v1.0.3.msi`.
...
``Install-Package Asgardio.Sdk.Oidc -Version 1.0.3``

#### Using the library DLL
1. Download [Asgardio.Sdk.Oidc.dll](https://github.com/asgardio/asgardio-dotnet-oidc-sdk/releases/download/v1.0.3/Asgardio.Sdk.Oidc.dll).
