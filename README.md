...
``Install-Package Asgardio.Sdk.Oidc -Version 1.0.2``

#### Using the library DLL
1. Download [Asgardio.Sdk.Oidc.dll](https://github.com/asgardio/asgardio-dotnet-oidc-sdk/releases/download/v1.0.2/Asgardio.Sdk.Oidc.dll).
